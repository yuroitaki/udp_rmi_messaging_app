...
public class UDPClient {
  ...
  public static void main(String[] args) {
	    ...
	    System.err.println("Bad server address in UDPClient, " + args[0] + " caused an unknown host exception " + e);
	    System.exit(-1);
		}
  ...
  private void testLoop(InetAddress serverAddr, int recvPort, int countTo) {
	...
	private void send(MessageInfo payload, InetAddress destAddr, int destPort) {
		...
		try {
     	// Convert a MessageInfo object into byte array
			...
			// Create a packet and send to the server
